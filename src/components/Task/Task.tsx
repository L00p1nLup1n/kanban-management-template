    ...
    <ScaleFade in unmountOnExit>
      ...
      >
        ...
        >
                ...
                >
                  ...
                  <PopoverBody>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        setLocalPriority(
                          e.target.value as TaskModel['priority'],
                        )
                      }
                    >
                    ...
                    >
                      {allMembers
                        .filter(
                          (member) => member.id !== getUserId(projectOwnerId),
                        )
                        .map((member) => (
              ...
              <Portal>
                ...
                >
                  ...
                  <PopoverFooter display="flex" justifyContent="flex-end">
                    <Button size="sm" variant="ghost" onClick={onStatusClose}>
                      Close
                    </Button>
                  </PopoverFooter>
                </PopoverContent>
          ...
          {/* Show move to backlog button to project owner */}
          {isOwner && handleMoveToBacklog && (
            <IconButton
              ...
              opacity={0}
              _groupHover={{ opacity: 1 }}
              onClick={handleMoveToBacklogClick}
